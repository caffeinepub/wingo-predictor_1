...
export class Backend implements backendInterface {
    ...
    async getNextPrediction(): Promise<Prediction> {
        if (this.processError) {
            try {
                const result = await this.actor.getNextPrediction();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getRecentResults(arg0: bigint): Promise<Array<PeriodResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentResults(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitPeriodResult(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPeriodResult(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
